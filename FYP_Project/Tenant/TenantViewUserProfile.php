<html>
    ...
    <body class="sub_page">
        ...
        $sql = "SELECT tenant.*, owner.*, house.*, condominium.*
                FROM tenant
	...
	$row = mysqli_fetch_assoc($result);  
        ...
        <div class="menu-container" id="menuContainer">
            <a href="TenantViewUserProfile.php" class="menu-item active" id="item1">View Profile</a>
        ...
        <form>
            <div class="UserProfile">
                ...
                <br>
                <a href="TenantEditUserProfile.php" class="ca" >Update Profile</a>
