    ...
    <body class="sub_page">
        ...
        if (isset($_POST['changePassword'])) {
                ...
                if (empty($op)) {
                    ...
                    $sql = "SELECT tenantPassword FROM tenant WHERE tenantID='$tenantID' AND tenantPassword='$op'";
                    $result = mysqli_query($conn, $sql);
                    if (mysqli_num_rows($result) === 1) {

                        $sql_2 = "UPDATE tenant SET tenantPassword='$newpassword' WHERE tenantID='$tenantID'";
                        $result2 = mysqli_query($conn, $sql_2);
                        if($result2){
                        session_unset();
                        session_destroy();
                        echo '<script>alert("Your password has been changed successfully!");</script>';
                        echo'<form id="message" action="../Owner/OwnerLogin.php" method="post">
        ...
        <div class="menu-container" id="menuContainer">
            ...
            <a href="TenantEditUserProfile.php" class="menu-item" id="item2">Update Profile</a>
            <a href="TenantChangePassword.php" class="menu-item active" id="item3">Change Password</a>
        </div>
            ...
            <div class="ResetPassword">
                ...
                <form action="" method="post" class="form" autocomplete="off">
                    <div class="input-field">
                        ...
                        <input type="password" name="oldPassword" class= "input" placeholder="Enter your old password" value="<?php if (isset($_POST['changePassword'])) {echo $op;} ?>">  
                    </div>
                    <div class="input-field">
                        <label class="input-label">New Password</label>
                        <input type="password" name="password" class= "input" placeholder="Enter your new password" value="<?php if (isset($_POST['changePassword'])) {echo $newpassword;} ?>">   
                    </div>
                    <div class="input-field">
                        <label class="input-label">Confirm Password</label>
                        <input type="password" name="re_password" class= "input" placeholder="Enter your new re-password" value="<?php if (isset($_POST['changePassword'])) {echo $c_np;} ?>">    
                    </div>
