<html>
    ...
    <body class="sub_page">
        ...
        <div class="menu-container" id="menuContainer">
            <a href="TenantRecord.php" class="menu-item active" id="item1">Tenant</a>
        ...
        <div class="page">
            ...
            <div class="row">
                ...
                <a href="TenantRecord.php" class="refresh">
		...
		<table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php
                        $total_rows = $conn->query('SELECT * FROM tenant WHERE ownerID="$ownerID" ORDER BY tenantStatus')->num_rows;
                        $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                        $num_results_on_page = 10;
                        if ($stmt = $conn->prepare('SELECT * FROM tenant WHERE ownerID= ? ORDER BY tenantStatus LIMIT ?,?')) {
