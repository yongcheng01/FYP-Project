    ...
    <body class="sub_page">
        ...
        <div class="page">
            ...
            <div class="row">
                ...
                <a href="visitorView.php" class="refresh"> 
                ...
                <form method="post" id="visitor">
                    <div class="row">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                <?php
                                $total_rows = $conn->query("SELECT * FROM visitor WHERE ".$whereText." = $userID")->num_rows;
                                $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                                $num_results_on_page = 5;
                                if ($stmt = $conn->prepare("SELECT * FROM visitor WHERE ".$whereText." = $userID ORDER BY CASE WHEN visitorStatus = 'Pending' THEN 1 ELSE 2 END, visitorStatus DESC, visitDate DESC LIMIT ?,?")) {
                                ...
                                <tr>
                                    ...
                                    <td data-label="Visitor Name"><a href="visitorDetailOwner.php?vID=<?= $visitor['visitorID'] ?>"><?= $visitor['visitorName'] ?></a></td>
                    ...
                    <div class="rowbtn">
                        ...
                        <button class="delete" formaction="visitorDelete.php" onclick="confirmDelete()">Delete</button>
                    </div>
                </form>
            </div>
        </div>
