<html>
    ...
    <body>
        ...
        ?>
        <div class="title">Owner Management Function</div>
        <div class="wholePage">
            <div class="page">
                <div class="row">
                    <div class="search">
                    ...
                    <a href="OwnerSearch.php"><label class="refresh">if no data click here refresh</label></a>
                ...
                <div id="searchresult">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                <?php
                                $total_rows = $conn->query('SELECT owner.*, house.*, condominium.*
                                                    FROM owner
                                ...
                                if ($stmt = $conn->prepare('SELECT owner.*, house.*, condominium.*
                                                    FROM owner
                                                    INNER JOIN house ON owner.houseID = house.houseID
                                                    INNER JOIN condominium ON owner.condoID = condominium.condoID 
                                                    ORDER BY ownerID LIMIT ?,?')) {
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        echo "<tr><td colspan='8'>No Owner found</td></tr>";
                                    }
                                } ?>
                            </tbody>
                        </table>
