<html>
    ...
    <body class="sub_page">
        ...
        <div class="menu-container" id="menuContainer">
            <a href="MaintenanceSearch.php" class="menu-item active" id="item1">Maintenance</a>
        ...
        <div class="page">
            ...
            <div class="row">
                ...
                <a href="MaintenanceSearch.php" class="refresh">
		...
		<table class="table table-hover table-bordered">
		    ...
		    <tbody>
                        <?php
                        $status = "Pending";
                        $total_rows = $conn->query("SELECT * FROM maintenance WHERE ownerID = '$ownerID' and maintenanceStatus = '$status'")->num_rows;
                        $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                        $num_results_on_page = 5;
                        if ($stmt = $conn->prepare('SELECT * FROM maintenance WHERE ownerID = ? and maintenanceStatus = ? ORDER BY ownerID LIMIT ?,?')) {
                            // Calculate the page to get the results we need from our table.
                            $calc_page = ($page - 1) * $num_results_on_page;
                            $stmt->bind_param('issi', $ownerID, $status, $calc_page, $num_results_on_page);
                            $stmt->execute();
                            // Get the results...
                     ...
                     $no++ ;
                     ?>
                        <?php } } else{ echo "<tr><td colspan='8'>No Maintenance Record found</td></tr>"; }}  ?>
                    </tbody>
                </table>
