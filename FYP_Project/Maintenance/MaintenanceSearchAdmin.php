<html>
    ...
    <body>
        ...
        ?>
        <div class="title">Maintenance Management Function</div>
        <div class="wholePage">
            <div class="page">
                <div class="row">
                    <div class="search">
                    ...
                    <a href="MaintenanceSearchAdmin.php"><label class="refresh">if no data click here refresh</label></a>
                ...
                $(document).ready(function() {
                    $("#live-search").keyup(function() {
                        ...
                        if (input != "") {
                            $.ajax({
                                url: "MaintenanceLiveSearchAdmin.php",
                                method: "POST",
                                data: {input: input},
                    ...
                    <div class="row">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                $status = "Cancelled";
                                $mainStatus = "Pending";
                                $total_rows = $conn->query("SELECT m.*, o.*, h.*, c.*
                                                            FROM maintenance m
                                                            ...
                                                            ORDER BY SUBSTRING_INDEX(m.maintenanceStatus, 'Pending', -1)")->num_rows;
                                $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                                $num_results_on_page = 10;
                                if ($stmt = $conn->prepare('SELECT m.*, o.*, h.*, c.*
                                                            FROM maintenance m
                                                            INNER JOIN owner o ON m.ownerID = o.ownerID
                                                            INNER JOIN house h ON o.houseID = h.houseID
                                                            INNER JOIN condominium c ON h.condoID = c.condoID
                                                            ORDER BY SUBSTRING_INDEX(m.maintenanceStatus, "Pending", -1)
                                                            LIMIT ?,?')) {
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        echo "<tr><td colspan='8'>No employee found</td></tr>";
                                    }
                                } ?>
                            </tbody>
                        </table>
