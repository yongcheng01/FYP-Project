<html>
    ...
    <body class="sub_page">
        ...
        <div class="menu-container" id="menuContainer">
            ...
            <a href="MaintenanceHistory.php" class="menu-item active" id="item3">History</a>
        </div>
        ...
        <div class="page">
            ...
            <div class="row">
                <div class="search">
                 ...
                 <a href="MaintenanceHistory.php" class="refresh">
                    <i class="las la-sync reload-icon" style="font-size: 25px; margin-top: 5px;"></i>
                        ...
                        $(document).ready(function() {
                            $("#live-search").keyup(function() {
                                ...
                                if (input != "") {
                                    $.ajax({
                                        url: "MaintenanceHistoryLiveSearch.php",
                                        method: "POST",
                                        data: {input: input},
		      ...
		      <tr>
		        ...
		        <th>Status</th>
                    ...
                    <tbody>
                        ...
                        $status = "Canceled";
                        $mainStatus = "Approved";
                        $total_rows = $conn->query("SELECT * FROM maintenance WHERE ownerID = '$ownerID' and (maintenanceStatus = '$status' or maintenanceStatus = '$mainStatus')")->num_rows;
                        $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                        $num_results_on_page = 5;
                        if ($stmt = $conn->prepare('SELECT * FROM maintenance WHERE ownerID = ? and (maintenanceStatus = ? or maintenanceStatus = ?) ORDER BY ownerID LIMIT ?,?')) {
                            // Calculate the page to get the results we need from our table.
                            $calc_page = ($page - 1) * $num_results_on_page;
                            $stmt->bind_param('issii', $ownerID, $status, $mainStatus, $calc_page, $num_results_on_page);
                            $stmt->execute();
                            // Get the results...
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="">
                                            <?php echo'<button class="btnbtn"><a href="MaintenanceHistoryView.php? viewid=' . $row["maintenanceID"] . '">View</a></button>' ?>
                                        </td>
                                    </tr>
                                    <?php
                                    $no++;
                                ...
                                echo "<tr><td colspan='8'>No Maintenance Record Found</td></tr>";
                            }
                        } ?>
                    </tbody>
                </table>
