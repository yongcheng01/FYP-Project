...
<html>
    ...
    <body>
        ...
        <div class="title">Facilities Management Function</div>
        <div class="wholePage">
            <div class="page">
                <div class="row">
                    <div class="search">
                    ...
                    <a href="facilitiesFunction.php"><label class="refresh">if no data click here refresh</label></a>
                </div>
                ...
                <div id="searchresult">
                    ...
                    <div class="row">
                        <table>
                            ...
                            <tbody>
                                <?php
                                $total_rows = $conn->query("SELECT facilities.*, condominium.condoName 
                                                            FROM facilities 
                                                            INNER JOIN condominium ON facilities.condoID = condominium.condoID 
                                                            WHERE facilitiesStatus != 'Removed'")->num_rows;
                                $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                                $num_results_on_page = 5;
                                if ($stmt = $conn->prepare("SELECT facilities.*, condominium.condoName 
                                                            FROM facilities 
                                                            INNER JOIN condominium ON facilities.condoID = condominium.condoID 
                                                            WHERE facilitiesStatus != 'Removed' 
                                                            ORDER BY condoID LIMIT ?,?")) {
