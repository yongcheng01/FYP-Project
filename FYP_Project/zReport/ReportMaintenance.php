    ...
    <body>
        ...
        <script>
                ...
                function chkReportVld() {
                    ...
                    const form1 = document.getElementById('maintenanceReport');
        ...
        <div class="page">
            <div class="form">
                ...
                <div class="header">
                    <div class="left">
                        <h1>Maintenance Report Query</h1>
                    </div>
                    <div class="right">
                ...
                <form id="maintenanceReport" action="reportPrintMaintenance.php" method="post">
