    ...
    <body>
        ...
        <script>
                ...
                function chkReportVld() {
                    ...
                    const form1 = document.getElementById('PaymentReport');
        ...
        <div class="page">
            <div class="form">
                ...
                <form id="PaymentReport" action="ReportPrintPayment.php" method="post">
                    ...
                    <div class="row">
                        <label>Status</label>
                        <select name="reportStatus" id="reportStatus" class="input">
