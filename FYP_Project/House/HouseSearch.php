<html>
    ...
    <body>
        ...
        ?>
        <div class="title">House Management Function</div>
        <div class="wholePage">
            <div class="page">
                <div class="row">
                    <div class="search">
                    ...
                    <a href="HouseSearch.php"><label class="refresh">if no data click here refresh</label></a>
                ...
                <form method="post">
                    <button class="btn" formaction="HouseAdd.php">Add House</button>   
                </form>
                ...
                <div id="searchresult">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                <?php
                                $total_rows = $conn->query('SELECT house.*, condominium.condoName, owner.ownerFName, owner.ownerLName
                                                    FROM house
                                                    INNER JOIN condominium ON house.condoID = condominium.condoID 
                                                    LEFT JOIN owner ON house.houseID = owner.houseID
                                                    ORDER BY house.houseStatus, house.condoID, house.houseID')->num_rows;
                                $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                                $num_results_on_page = 10;
                                if ($stmt = $conn->prepare('SELECT house.*, condominium.condoName, owner.ownerFName, owner.ownerLName
                                                    FROM house
                                                    INNER JOIN condominium ON house.condoID = condominium.condoID 
                                                    LEFT JOIN owner ON house.houseID = owner.houseID
                                                    ORDER BY house.houseStatus, house.condoID, house.houseID LIMIT ?,?')) {
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        echo "<tr><td colspan='8'>No house found</td></tr>";
                                    }
                                } ?>
                            </tbody>
                        </table>
