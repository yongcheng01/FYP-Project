<html>
    ...
    <body>
        ...
        ?>
        <div class="title">Admin Management Function</div>
        <div class="wholePage">
            <div class="page">
                <div class="row">
                    <div class="search">
                    ...
                    <a href="AdminSearch.php"><label class="refresh">if no data click here refresh</label></a>
                ...
                <form method="post">
                    <button class="btn" formaction="AdminRegister.php">Register</button>    
                </form>
                <div id="searchresult">
                    <div class="row">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                <?php
                                $total_rows = $conn->query('SELECT * FROM admin')->num_rows;
                                $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
                                $num_results_on_page = 5;
                                if ($stmt = $conn->prepare('SELECT * FROM admin ORDER BY adminStatus LIMIT ?,?')) {
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        echo "<tr><td colspan='8'>No Admin Record Found</td></tr>";
                                    }
                                }
                                ?>
                            </tbody>
